const CACHE='emergency-care-assistant-v03';
const ASSETS=['./','./index.html','./styles.css','./enhancements.css','./data.js','./app.js','./enhancements.js','./manifest.webmanifest','./icon.svg'];
