const CACHE='emergency-care-assistant-v04-clinical';
const ASSETS=['./','./index.html','./styles.css','./enhancements.css','./clinical.css','./data.js','./clinical-data.js','./app.js','./enhancements.js','./clinical.js','./manifest.webmanifest','./icon.svg'];
