(() => {
  ...
  const mappings = [
    { emergencyName: '阿司匹林', status: 'resolved', drugId: 'drug-025', matchedBy: 'genericName', canonicalName: '阿司匹林肠溶片' },
    { emergencyName: '葡萄糖', status: 'resolved', drugId: 'drug-096', matchedBy: 'genericName', canonicalName: '葡萄糖注射液' },
  ...
  window.EMERGENCY_DRUG_ID_MIGRATION_V020 = Object.freeze({
    ...
    policy: 'Only unique matches receive drugId; missing or ambiguous names remain unresolved for clinical and inventory review.',
